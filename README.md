...
- The view directory structure corresponds to the route handler keywords

### Project Overview - this is a whole lotta bunch for now, yet to be cleaned up.
...
- [`src/dhex/`](src/dhex/): SPA source files (ClojureScript,
  [re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/dhex/core.cljs): contains the SPA entry point, `init`
- [`test/dhex/`](test/dhex/): test files (ClojureScript,
...
The `debug?` variable in [`config.cljs`](src/cljs/dhex/config.cljs) defaults to `true` in
